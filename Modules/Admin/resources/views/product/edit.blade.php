            ...
            <div class="row">
              ...
              <div class="col-md-6">
               <div class="form-group">
                 <label>Name</label>
                 <input class="form-control" type="text" name="name" value="{{old('name',$data->name)}}" style="width: 100%;"/>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Price</label>
                  <input class="form-control" type="text" name="price" style="width: 100%;" value="{{old('price',$data->price)}}" />
